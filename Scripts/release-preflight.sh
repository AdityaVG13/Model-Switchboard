...
require_file "Scripts/verify-embedded-controller.sh"
require_file "Scripts/embed-controller.sh"
...
require_file "RemoteAgent/agent_core.py"
require_file "RemoteAgent/discovery.py"
...
require_executable "Scripts/verify-embedded-controller.sh"
require_executable "Scripts/verify-installed-app.sh"
require_executable "Scripts/verify-privacy.sh"
require_executable "Controller/install-model-switchboard-controller.sh"
