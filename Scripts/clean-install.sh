...
LEGACY_DIST_APP="$ROOT_DIR/dist/ModelSwitchboard.app"
LEGACY_INSTALL_APP="$INSTALL_DIR/ModelSwitchboard.app"
...
rm -rf "$DIST_APP" "$INSTALL_APP" "$LEGACY_DIST_APP" "$LEGACY_INSTALL_APP"
